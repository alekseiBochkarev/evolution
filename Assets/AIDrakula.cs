...
public class AIDrakula : AI
{
    ...
    public override void FindGoalToMove()
    {
        ...
        for (int i = 0; i < colliders.Length; i++)
        {
            ...
            //else if (!Equals("food", colliders[i].gameObject.name) & !Equals("wall", colliders[i].gameObject.name))
    ...
    public void OnTriggerEnter2D(Collider2D col)
    {
        ...
        {
            //bullet
            GameObject bullet = (GameObject)UnityEngine.Object.Instantiate(Resources.Load("bullet", typeof(GameObject)), new Vector3(0, 0, 0), Quaternion.identity);
            bullet.transform.position = transform.position;
            bullet.transform.SetParent(this.gameObject.transform);
            bullet.GetComponent<BulletScript>().StartMovingTowards(col.gameObject.transform.position, bulletSpeed);
    ...
    {
        transform.GetChild(0).gameObject.transform.eulerAngles = new Vector3(0f, 0f, Mathf.Atan2(rb.velocity.y, rb.velocity.x) * Mathf.Rad2Deg - 90);
    ...
    public override void Init(Genome g)
    {
        ...
        */
        ...
        switch (command)
        {
            ...
            case 0:
                {
                    transform.GetChild(0).gameObject.GetComponent<SpriteRenderer>().color = UnityEngine.Color.magenta;
                    break;
                }
        }
